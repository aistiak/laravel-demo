...
$(document).ready(function(){
	...
	$('.login-form button').on('click',function(){
		...
		var url = 'http://localhost/laravel/me/api/public/api/login'
	/*	var prams = {
			email : username,
			password : password
		}
		...
		console.log('clicked')*/
		var request = $.ajax({
			url: 'http://localhost/laravel/me/api/public/api/login',
			type: 'post',
			data: {
				email :username,
				password:password
...
/*			headers: {
 ...
 /*  			success: function (data) {
		...
		request.success(function(data){
                 ...
                 location.href = 'http://localhost/laravel/me/www/app.html'
	...
	$('.register-form button').on('click',function(){
		...
		var request = $.ajax({
			url:  'http://localhost/laravel/me/api/public/api/register',
			type: 'post',
			data : {
